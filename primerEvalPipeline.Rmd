...
for(commandToCheck in c("blast", "blastdbcmd", "mafft", "perl", "bsPrimerBlast.pl",
...
for(perlScript in c("perl scripts/filterFastaNs.pl", "perl scripts/uniqueFastaBySpeciesSeq.pl",
