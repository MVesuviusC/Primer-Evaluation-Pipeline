...
opts_chunk$set(fig.height = 10, 
               fig.width = 20, 
               cache = TRUE, 
               cache.path = paste(outDir, "cache"), 
               cache.extra = list(primerFile))
```
...
change blast output to better fit what I need for finding potential hits, adjust scripts/findTopBlastHitsWithTaxa.pl
...
## Generate list of amplifiable hits
Do this after finding potential hits since the taxaRaw file includes instances where only one primer hits
