...
~/bin/timeout -m 9999999999 \
  ...
  # need to run tests on megacc to see how long it takes to make a tree from x sequences and see what the relationship between time and number of seqs is (non-linear?)
